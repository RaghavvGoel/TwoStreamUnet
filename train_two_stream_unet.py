...
from utils_two_stream_unet import get_data
...
dir_checkpoint = 'checkpoints/exp/5'
...
def train_net(net,
    ...
    for one image, flow has 5 previous frames, can create Bx5xHxW for flow and Bx1XHxW for US images
    """
...
if __name__ == '__main__':
    ...
    ## TO CHECK: EFFECT OF BILINEAR AND N_CLASS = 1 ########################################
    net = TwoStreamUNet(spatial_in_channel=1, temporal_in_channel=5, out_channel=16, n_classes=4)

...
class TwoStream(nn.Module):
    def __init__(self, spatial_in_channel, temporal_in_channel, out_channel) -> None:
        super(TwoStream, self).__init__()
        '''
        initialise two streams of conv net and then pass output to unet
        try: (i) only forwarding image features via skip connection
        try: (ii) forwarding both optical flow features and image features
        '''
